-- Incluir subitems no get_my_work_items
-- Subitems atribuidos a uma pessoa agora aparecem no Meu Trabalho / Trabalho em Equipe
-- Adiciona parentItemId e parentItemName ao retorno para exibir vinculo visual
